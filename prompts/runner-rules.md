...
- Keep the full model JSON response under **64,000 characters** for daily tasks (**96,000** for weekly/monthly synthesis); prefer compact `append` / `replace_section` updates.
